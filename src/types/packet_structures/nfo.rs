...
pub fn build_nfo_struct(transaction_id: i16, buf: &[u8]) -> NfoBroadcastTransactionMapping {
    match transaction_id {
        5294 => NfoBroadcastTransactionMapping::BcastContMsg(bytes_to_struct(buf)),
        6013 => NfoBroadcastTransactionMapping::BcastSecurityOpenPrice(bytes_to_struct(buf)),
        6501 => NfoBroadcastTransactionMapping::BcastJrnlVctMsg(bytes_to_struct(buf)),
        6511 => NfoBroadcastTransactionMapping::BcastOpenMessage(bytes_to_struct(buf)),
        6521 => NfoBroadcastTransactionMapping::BcastCloseMessage(bytes_to_struct(buf)),
        6531 => NfoBroadcastTransactionMapping::BcastPreopenShutdownMsg(bytes_to_struct(buf)),
        6541 => NfoBroadcastTransactionMapping::BcastCircuitCheck(bytes_to_struct(buf)),
        6571 => NfoBroadcastTransactionMapping::BcastNormalMktPreopenEnded(bytes_to_struct(buf)),
        7130 => NfoBroadcastTransactionMapping::BcastMktMvmtCmOiIn(bytes_to_struct(buf)),
        7200 => NfoBroadcastTransactionMapping::BcastMboMbpUpdate(bytes_to_struct(buf)),
        7201 => NfoBroadcastTransactionMapping::BcastMwRoundRobin(bytes_to_struct(buf)),
        7202 => NfoBroadcastTransactionMapping::BcastTickerAndMktIndex(bytes_to_struct(buf)),
        7203 => NfoBroadcastTransactionMapping::BcastIndustryIndexUpdate(bytes_to_struct(buf)),
        7206 => NfoBroadcastTransactionMapping::BcastSystemInformationOut(bytes_to_struct(buf)),
        7208 | 18705 => NfoBroadcastTransactionMapping::BcastOnlyMbp(bytes_to_struct(buf)),
        7210 => NfoBroadcastTransactionMapping::BcastSecurityStatusChgPreopen(bytes_to_struct(buf)),
        7211 => NfoBroadcastTransactionMapping::BcastSpdMbpDelta(bytes_to_struct(buf)),
        7220 => {
            NfoBroadcastTransactionMapping::BcastLimitPriceProtectionRange(bytes_to_struct(buf))
        }
        7305 => NfoBroadcastTransactionMapping::BcastSecurityMstrChg(bytes_to_struct(buf)),
        7306 => NfoBroadcastTransactionMapping::BcastPartMstrChg(bytes_to_struct(buf)),
        7320 => NfoBroadcastTransactionMapping::BcastSecurityStatusChg(bytes_to_struct(buf)),
        7324 => NfoBroadcastTransactionMapping::BcastInstrMstrChg(bytes_to_struct(buf)),
        7340 => NfoBroadcastTransactionMapping::BcastSecMstrChngPeriodic(bytes_to_struct(buf)),
        7341 => NfoBroadcastTransactionMapping::BcastSpdMstrChgPeriodic(bytes_to_struct(buf)),
        9010 => NfoBroadcastTransactionMapping::BcastTurnoverExceeded(bytes_to_struct(buf)),
        9011 => NfoBroadcastTransactionMapping::BcastBrokerReactivated(bytes_to_struct(buf)),
        _ => panic!("Invalid fao transaction id: {}", transaction_id),
    }
}
