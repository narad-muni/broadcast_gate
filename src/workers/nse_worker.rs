...
pub fn convert_mbo_mbp(
    ...
    let picture = TagMarketPictureBroadcast {
        ...
        ltt: bcast_mbo_mbp.mbo_data.last_trade_time + NSE_EPOCH_START,
        atp: bcast_mbo_mbp.mbo_data.average_trade_price,
        indicative_close_price: 0,
        lut: i64::from_le_bytes(bcast_mbo_mbp.bcast_header.time_stamp2),
        buy_depth_count,
        sell_depth_count,
...
pub fn convert_only_mbp(
    ...
    let picture = TagMarketPictureBroadcast {
        ...
        ltt: bcast_only_mbp.mbp_data[idx].last_trade_time + NSE_EPOCH_START,
        atp: bcast_only_mbp.mbp_data[idx].average_trade_price,
        indicative_close_price: 0,
        lut: i64::from_le_bytes(bcast_only_mbp.bcast_header.time_stamp2),
        buy_depth_count,
        sell_depth_count,
...
pub fn convert_only_mbp_cedtc(
    ...
    let picture = TagMarketPictureBroadcast {
        ...
        ltt: bcast_only_mbp_cedtc.mbp_data[idx].last_trade_time + NSE_EPOCH_START,
        atp: bcast_only_mbp_cedtc.mbp_data[idx].average_trade_price,
        indicative_close_price: 0,
        lut: i64::from_le_bytes(bcast_only_mbp_cedtc.bcast_header.time_stamp2),
        buy_depth_count,
        sell_depth_count,
